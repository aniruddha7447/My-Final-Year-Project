...
logo_label1=tk.Label(text='Fake Instagram Profile Identification \n and Classification using Machine Learning',font=("Times New Roman", 20, 'bold', 'italic'),width=35, bg="#cce6ff", fg="black")
#logo_label=tk.Label(height=500, width=400)
logo_label1.place(x=800,y=550)
