...
image2 =Image.open('98.jpg')
image2 =image2.resize((1550,1000))
...
background_label.place(x=0, y=0) #, relwidth=
...
title.place(x=840,y=30,width=250)
        
Login_frame=tk.Frame(root,bg="white")
Login_frame.place(x=720,y=100)
